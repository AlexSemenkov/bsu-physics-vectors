...
public class CommonMathVector extends Vector implements VectorMultipliable<CommonMathVector> {
    ...
    public CommonMathVector multiply(CommonMathVector vector) {
        return new CommonMathVector(vector3D.crossProduct(vector.vector3D));
    }
